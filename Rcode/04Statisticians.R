...
tempwd <- ("/Users/happyrabbit/Documents/GitHub/rscraping-jsm-2016/data/wikipediaStatisticians")
#dir.create(tempwd)
setwd(tempwd)
...
to_count_df<-arrange(to_count_df, desc(n))
setwd("/Users/happyrabbit/Documents/GitHub/Projects/UnstrData")
write.csv(to_count_df,"StatisticianR.csv",row.names=F)
